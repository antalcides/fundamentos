...
definición %
\begin{tabular}{cccc}
$\rightarrow$ : & $V\times V$ & $\rightarrow$ & %
$V$%
\tabularnewline
 & $\left(x,y\right)$ & $\mapsto$ & $z$\tabularnewline
...
definición %
\begin{tabular}{cccc}
$\leftrightarrow$ : & $V\times V$ & $\rightarrow$ & %
$V$%
\tabularnewline
 & $\left(x,y\right)$ & $\mapsto$ & $z$\tabularnewline
...
$\sim\left(\sim p\right)\equiv p$\end{ley}
